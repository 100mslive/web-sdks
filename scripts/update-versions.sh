...
lerna add @100mslive/hls-player --scope=@100mslive/roomkit-react --peer --exact
lerna add @100mslive/hms-virtual-background --scope=@100mslive/roomkit-react --peer --exact
lerna add @100mslive/react-icons --scope=@100mslive/roomkit-react --peer --exact
lerna add @100mslive/react-sdk --scope=@100mslive/roomkit-react --peer --exact
