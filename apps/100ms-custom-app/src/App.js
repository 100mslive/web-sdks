...
import { EdtechComponent as HMSEdtechTemplate } from "./100ms-web-v2/src/App";
...
class App extends Component {
    ...
    getWithRetry(url, headers)
      ...
      .catch((err) => {
        const errorMessage = `[FetchData - get-details] ${err.message} ${
          err.toJSON && JSON.stringify(err.toJSON())
        }`;
        let error = {
  ...
  storeSettings = async (jwt) => {
    ...
    formData.append(
      "screenshare",
      getBoolean(currentSettings.plugins["screen-share"])
    );
    formData.append(
      "annotation",
      getBoolean(currentSettings.plugins["universal-annotation"])
    );
    formData.append(
      "background",
      getBoolean(currentSettings.plugins["virtual-bg"])
    );
    formData.append("spotlight", getBoolean(currentSettings.plugins.spotlight));
    formData.append(
      "raise_hand",
      getBoolean(currentSettings.plugins["raise-hand"])
    );
    formData.append(
      "google_drive",
      getBoolean(currentSettings.plugins["google-drive"])
    );
          ...
          <>
            ...
            <HMSEdtechTemplate
              ...
              themeConfig={{
                ...
                showScreenshare:
                  this.state.temporary_state.plugins["screen-share"].toString(),
                logo:
                  this.state.temporary_state.logo_url ||
                  (this.state.temporary_state.theme === "dark"
                    ? logoDark
                    : logoLight),
                showAvatar: "true",
                ...
                <div className="max-w-screen-md min-h-[530px] flex flex-col justify-between w-3/4 py-5 px-2.5 text-white rounded-xl bg-gray-cool6">
                  <div>
                    <div className="flex items-center px-2.5 mb-4">
                      ...
                      >
                        <span
                          className={`focus:outline-none  text-2xl text-gray-cool4 text-white`}
                          aria-hidden="true"
                        >
                          &times;
                        </span>
                    ...
                    Layout
                        ...
                        <div
                          ...
                          className={`w-full p-5 rounded-lg mb-2.5 cursor-pointer hover:bg-gray-cool2 hover:bg-opacity-40 ${
                            this.state.activeTab === "theme"
                              ? "bg-gray-cool2 text-white"
                              : " text-gray-cool5"
                          }`}
                        >
                          Theme
    ...
    return (
      <>
            ...
            values={[
              <div className="flex">
                <img
                  className="w-12 mr-4"
                  src={GridLayout}
                  alt="grid layout icon"
                />
                <div className="flex flex-col">
                  <div className="text-sm">Grid View</div>
                  <div className="text-xs">
                    Participants will be in a grid. You can choose to allow one
                    role’s participants to be in a sidebar.
                  </div>
                </div>
              </div>,
              <div className="flex">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="text-xs">
                    Active speaker will be shown prominently. You can choose to
                    allow select roles to be on stage.{" "}
                  </div>
                </div>
              </div>,
            ]}
        ...
        <div className="flex justify-between items-center mt-4 mb-4">
          <span className=" text-gray-cool5 text-sm font-normal">
            Sidebar should show...
          </span>
          <Dropdown
        ...
        <div className=" flex items-center text-gray-cool5 duration-500 rounded-lg max-w-xsm">
          <button
            ...
            className={` my-1 mx-2 p-0.5 rounded-lg text-sm font-normal focus:outline-none border ${
              props.settings.tile_shape === "1-1"
                ? "border-blue-standard"
                : " border-gray-cool6"
            }`}
          >
            <div className="flex items-center justify-center w-20 h-20 bg-gray-cool2 rounded-md">
              Square
            </div>
          </button>
          <button
            ...
            className={` my-1 mx-2 p-0.5 rounded-lg text-sm font-normal focus:outline-none border ${
              props.settings.tile_shape === "4-3"
                ? "border-blue-standard"
                : " border-gray-cool6"
            }`}
          >
            <div className="flex items-center justify-center w-28 h-20 bg-gray-cool2 rounded-md">
              Landscape
            </div>
          </button>
          <button
            ...
            className={` my-1 mx-2 p-0.5 rounded-lg text-sm font-normal focus:outline-none border ${
              props.settings.tile_shape === "16-9"
                ? "border-blue-standard"
                : " border-gray-cool6"
            }`}
          >
            <div className="flex items-center justify-center w-36 h-20 bg-gray-cool2 rounded-md">
              Wide
            </div>
          </button>
        </div>
    ...
    const pluginsAndApps = [
      {
        ...
        icon: chat,
        description:
          "Chat with and send files to all participants, or in private. Get chat logs after the call.",
      },
      {
        name: "Screen Share",
        id: "screen-share",
        icon: shareScreen,
        description:
          "Participants can share their screen or view others’ screens.",
      },
      // {
    ...
    <>
      <div className=" py-3 px-9 flex items-center bg-gray-cool2 rounded-lg">
        ...
        <div className="text-sm font-normal ml-2">
          These settings will apply to this demo session only.
        </div>
      </div>
      <div className="flex justify-between mt-6 mb-4">
        <span className=" text-gray-cool5 text-sm font-normal">
          Role to assign to every new participant
        </span>
        <Dropdown
