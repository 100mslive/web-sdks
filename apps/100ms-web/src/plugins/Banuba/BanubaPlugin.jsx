...
import { Player, Image, Effect, ImageCapture } from "./BanubaSDK.js";
...
class BanubaPlugin {
  ...
  async init() {
    ...
    this.effect = new Effect("./effects/BackgroundPicture.zip");
...
export const BanubaPluginIcon = () => {
  const isVBPresent = useHMSStore(selectIsLocalVideoPluginPresent("banuba"));
