    ...
    peerStats: {
      '1': {
        publish: {
          ...
          localCandidate: {
            id: 'RTCIceCandidate_A0fSQWW9',
            timestamp: 1639819837327.096,
            type: 'local-candidate',
            transportId: 'RTCTransport_0_1',
            candidateType: 'srflx',
            protocol: 'udp',
            address: '223.181.114.100',
            port: 14154,
            networkType: 'wifi',
          },
          remoteCandidate: {
            id: 'RTCIceCandidate_PhswlWnB',
            timestamp: 1639819837327.096,
            type: 'remote-candidate',
            transportId: 'RTCTransport_0_1',
            candidateType: 'srflx',
            protocol: 'udp',
            address: '35.200.223.203',
            port: 29080,
          },
        },
        subscribe: {
