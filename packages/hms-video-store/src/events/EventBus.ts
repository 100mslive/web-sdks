...
import { HMSDeviceChangeEvent, HMSRole, HMSTrackInterruption } from '../interfaces';
import {
  HMSLocalAudioTrack,
  HMSLocalVideoTrack,
  HMSRemoteAudioTrack,
...
export class EventBus {
  ...
  readonly trackInterruption = new HMSInternalEvent<HMSTrackInterruption>(
    HMSEvents.TRACK_INTERRUPTION,
    this.eventEmitter,
  );
