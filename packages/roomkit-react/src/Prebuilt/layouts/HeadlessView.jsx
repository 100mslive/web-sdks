...
import { InsetView } from '../layouts/InsetView';
...
function HeadlessView() {
  ...
  }, [width, height, maxTileCount, vanillaStore, sortedPeers, page, isMobile]);
  ...
  console.log('here', pagesWithTiles, page, peers);
  ...
  return (
    <Flex direction="column" css={{ flex: '1 1 0', h: '100%', position: 'relative', minWidth: 0 }}>
      ...
      {peers.length > 0 && <InsetView inset={false} />}
    </Flex>
  );
}
