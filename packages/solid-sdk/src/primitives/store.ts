...
export function makeHMSStoreHook(hmsContext: Solid.Context<HMSContextProviderProps | null>) {
...
export function makeHMSStatsStoreHook(hmsContext: Solid.Context<HMSContextProviderProps | null>) {
