...
const SvgColoredHandIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="none" viewBox="0 0 40 40" {...props}>
    <g clipPath="url(#ColoredHandIcon_svg__a)">
      <path fill="url(#ColoredHandIcon_svg__b)" d="M5.747 10.359q.007-.005.014-.008v-.002z" />
      <path
        fill="url(#ColoredHandIcon_svg__c)"
        d="M9.005 8.58c-.953-.954-1.977-.793-2.766-.004L5.106 23.108c0 .137.013.273.02.41l8.152-8.151c-3.411.89-2.409-1.958-3.592-2.694 0 0 1.307-2.105-.68-4.094"
      />
      <path
        fill="url(#ColoredHandIcon_svg__d)"
        d="M34.57 17.645a1.666 1.666 0 0 0-2.357 0l-4.818 4.818-.535-.643 8.005-8.005a2.083 2.083 0 1 0-2.946-2.946l-7.74 7.738-.535-.643L31.92 9.69a2.083 2.083 0 1 0-2.947-2.946l-8.008 8.008-.536-.643 6.103-6.102c.77-.771.918-2.027.229-2.871a2.083 2.083 0 0 0-3.091-.16L5.126 23.519a6.66 6.66 0 0 0 1.934 4.328l6.297 6.297a5 5 0 0 0 7.071 0L34.57 20.002a1.666 1.666 0 0 0 0-2.357"
      />
      <path
        fill="#FFF0C9"
        d="M24.258 7.333a1.25 1.25 0 1 0 1.768-1.768 1.25 1.25 0 0 0-1.768 1.768M29.561 9.1a1.25 1.25 0 1 0 1.768-1.767A1.25 1.25 0 0 0 29.561 9.1M32.508 13.226a1.25 1.25 0 1 0 1.767-1.768 1.25 1.25 0 0 0-1.767 1.768M32.802 19.413a.833.833 0 1 0 1.179-1.179.833.833 0 0 0-1.179 1.179"
      />
    </g>
    <defs>
      <linearGradient
