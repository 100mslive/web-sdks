...
const SvgRocketIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="none" viewBox="0 0 24 24" {...props}>
    <path
      ...
      strokeWidth={1.5}
      d="m12.282 15.333-2.615-2.615m2.615 2.615a19.5 19.5 0 0 0 3.487-1.743m-3.487 1.743v4.36s2.642-.48 3.487-1.744c.942-1.413 0-4.36 0-4.36m-6.102-.87a19 19 0 0 1 1.743-3.444A11.23 11.23 0 0 1 21 4c0 2.371-.68 6.539-5.23 9.59m-6.103-.872h-4.36s.48-2.642 1.744-3.487c1.413-.942 4.36 0 4.36 0m-5.667 7.41C4.436 17.74 4 21 4 21s3.26-.436 4.359-1.744c.619-.732.61-1.857-.079-2.536a1.9 1.9 0 0 0-2.536-.079"
    />
  </svg>
);
