...
interface useRemoteAVToggleInput {
  /**
  * Audio track id of the peer whose tracks need to be managed
  */
  audioTrackId: HMSTrackID;
  /**
  * Video track id of the peer whose tracks need to be managed
  */
...
import { Video, Box, Flex, Button } from "@100mslive/react-ui"
