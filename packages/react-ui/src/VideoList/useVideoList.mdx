...
import { Video, StyledVideoList, getLeft } from '@100mslive/react-ui';
import { MicOffIcon } from '@100mslive/react-icons';

// refer to the Pagination example in the Pagination story
import Pagination from './Pagination';
// refer to the VideoTile example in the VideoTile story
import VideoTile from './VideoTile';

({ maxTileCount, aspectRatio }) => {
