...
invalidRes.forEach(data =>{
  test(`Start recording only with invalid resolutions ${data.width}X${data.height} @qaonly`, async() => {
...
testData.forEach(data =>{
  test(`Start recording only with different resolutions ${data.width}X${data.height} @qaonly`, async() => {
...
test(`Start and Stop HLS stream only @qaonly`, async () => {
...
testData.forEach(data =>{
test(`Start RTMP only with different resolutions ${data.width}X${data.height} @qaonly`, async() => {
  await page.click(page.header.go_live_btn, page.header.rtmp_stream_btn);
...
testData.forEach(data =>{
  test(`Start RTMP with recording with different resulutions ${data.width}X${data.height} @qaonly`, async() => {
    await page.click(page.header.go_live_btn, page.header.rtmp_stream_btn);
...
invalidRes.forEach(data =>{
test(`Start rtmp with invalid resolutions ${data.width}X${data.height} @qaonly  `,async () => {
  await page.click(page.header.go_live_btn, page.header.rtmp_stream_btn);
